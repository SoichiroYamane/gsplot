...
gs.line(ax["A"], [0, 1, 2], [0, 1, 4], label="quadratic")
gs.scatter(ax["B"], [0, 1, 2], [0, 1, 4], label="samples", s=15)
gs.label(ax, "x", "value", square=True, index="in")
gs.legend(ax)
gs.save(fig, "overview", show=False)
```
